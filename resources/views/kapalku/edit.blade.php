                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control @error('nama_kapal') is-invalid @enderror"
                                    name="nama_kapal" value="{{ old('nama_kapal', $kapal->nama_kapal) }}">
                                ...
                                <select class="form-control @error('id_jenis_kapal') is-invalid @enderror"
                                    ...
                                    @foreach ($jenisKapal as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($item->id === $kapal->id_jenis_kapal) selected @endif>
                                            {{ $item->jenis_kapal }}</option>
                                    @endforeach
                                </select>
                                <div class="invalid-feedback">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-3">
                                <input type="number" class="form-control @error('nama_kapal') is-invalid @enderror"
                                    name="ukuran" value="{{ old('ukuran', $kapal->ukuran) }}">
                                <div class="invalid-feedback">
                                    @error('ukuran')
                                        {{ $message }}
                                    @enderror
